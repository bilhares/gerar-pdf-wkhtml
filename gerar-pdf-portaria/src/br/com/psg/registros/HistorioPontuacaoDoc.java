...
public class HistorioPontuacaoDoc {

	public String gerarHtmlHistorioPontuacao(List<HistoricoPontuacao> param) {
//		FileUtil.criarPastas();
		...
		// cabecalho
		html.append("<div class=\"titulo\">Histórico de Pontuação</div> "
		...
		html.append(
				"<div class=\"linha\"><div class=\"esq4\" style=\"width: 11.84em; display: block\"><b>Auto</b><br>&nbsp;</div>"
						+ "<div class=\"esq4\" style=\"width: 11.84em; display: block\"><b>Causa</b><br>&nbsp;</div>"
						+ "<div class=\"esq4\" style=\"width: 11.84em; display: block\"><b>Data da Infração</b><br>&nbsp;</div>"
						+ "<div class=\"esq4\" style=\"width: 11.84em; display: block\"><b>Ponto</b><br>&nbsp;</div>"
						+ "<div class=\"esq4\" style=\"width: 11.84em; display: block\"><b>Situação</b>"
						+ "<br>&nbsp;</div></div>");

		for(HistoricoPontuacao params : param){
		html.append(
				"<div class=\"linha\"><div class=\"esq4\" style=\"width: 11.84em; display: block\"><b></b><br>"+params.getAUTO()+"&nbsp;</div>"
						+ "<div class=\"esq4\" style=\"width: 11.84em; display: block\"><b></b><br>"+params.getINFRACAO()+"&nbsp;</div>"
						+ "<div class=\"esq4\" style=\"width: 11.84em; display: block\"><b></b><br>"+params.getDATA_INFRACAO()+"&nbsp;</div>"
						+ "<div class=\"esq4\" style=\"width: 11.84em; display: block\"><b></b><br>"+params.getPONTO()+"&nbsp;</div>"
						+ "<div class=\"esq4\" style=\"width: 11.84em; display: block\"><b></b><br>"+params.getSITUACAO()+"&nbsp;</div></div>");
		}
		
		html.append("</div></div></body></html>");
		
		String arquivo = "";
		String nomeArquivo = "historicoPontuacao" + param.get(0).getCPF().trim() + "";
		try {

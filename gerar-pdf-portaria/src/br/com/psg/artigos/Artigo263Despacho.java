...
public class Artigo263Despacho {

	public String gerarPdf263DespachoInstauracao(Parametro param) {
...
//		html.append(" <h1 style=\"text-align: center\"> artigo_263(DESPACHO INSTAURAÇÃO SUSPENSÃO)</h1>");
		...
		html.append("Considerando que consta ativa no histórico da pontuação do condutor <b><u><i>"
		...
		html.append("</u></b>," + " artigo <b><u><i>" + param.getARTIGO_COMPLETO()
				+ "</i></u></b>, conforme extrato em anexo, passível de aplicação de penalidade de cassação do direito "
				+ " de conduzir veículos automotores nos termos da legislação vigente, solicito ao Senhor Diretor Presidente do DETRAN-MS abertura "
				+ " de processo administrativo para aplicação de penalidade de cassação do direito de conduzir veículos automotores com fundamento"
				+ " nos artigos 256 e 263 ambos do Código de Trânsito Brasileiro (CTB), além da realização do curso de reciclagem nos termos do "
				+ " artigo 268 do CTB c/c com a Resolução 168/2004.");
		html.append("</td>");
		html.append("</tr>");
		html.append("</table>");
		html.append("<p><p>");

...
public class Artigo263IIPortaria {
	public String gerarPdf263Portaria(Parametro param) {
	//	FileUtil.criarPastas();
		...
		html.append("</head>");
		html.append("<body>");
//		html.append("<h1 style=\"text-align: center\">artigo_" + param.getARTIGO_INCISO_WORK() + "II (PORTARIA)</h1>");
		...
		html.append(
				"<tr>" + "<td colspan=\"2\"><img src=\""+getClass().getResource("/br/com/psg/resources/topoDetran2.png")+"\"alt=\"logo\" name=\"logo\"  width=\"900\" height=\"146\"  hspace=\"12\" border=\"0\" align=\"top\" id=\"logo\"/>"
						+ "</td>" + "</tr>");
		html.append("<tr><td width=\"50%\">PORTARIA <b><u><i>" + param.getNUM_PORTARIA() + "</i></u></b> / <b><u><i>"
				+ param.getANO_PORTARIA() + "</i></u></b> - DETRAN-MS</td>"
				+ "<td width=\"50%\">Campo Grande, MS, <b><u><i>" + DataUtil.dataAtualExtenso()
				+ "</i></u></b>.</td></tr>");
		html.append("</table>");
		html.append("<p>");
		html.append("<table align=\"center\" width=\"100%\">");
		html.append(
				"<tr>" + "<td align=\"justify\" width=\"90%\">O DIRETOR PRESIDENTE DO DEPARTAMENTO ESTADUAL DE TRÂNSITO DO"
						...
						+ "</tr>");
		html.append(
				"<tr>" + "<td align=\"justify\" width=\"90%\">CONSIDERANDO o que autoriza o artigo 256 em seus incisos e parágrafos e artigo 261 ambos do CTB;</td>"
						+ "</tr>");
		html.append(
				"<tr>" + "<td align=\"justify\" width=\"90%\">CONSIDERANDO o que regulamenta a Resolução 182/2005, do CONTRAN.</td>"
						+ "</tr>");
		html.append("<tr>" + "<td align=\"justify\" width=\"90%\">RESOLVE:</td>" + "</tr>");
		html.append("<tr>"
				+ "<td align=\"justify\" width=\"90%\">1° INSTAURAR processo administrativo para a aplicação da penalidade de cassação do direito de conduzir veículos automotores em face de <b><u><i>"
				+ param.getNOME_WORK() + "</i></u></b>, portador da CNH n° <b><u><i>" + param.getNUMERO_CNH_WORK()
				+ "</i></u></b>," + " sob o registro <b><u><i>" + param.getNUMERO_REGISTRO_WORK()
				+ "</i></u></b>, com fundamento ao artigo 261, caput do CTB por infringência ao (s) artigo (s) <b>"+param.getARTIGO_COMPLETO()+" do CTB<b><u>, ");

		/*for (String auto : param.getAUTO()) {
			html.append("<i>" + auto + "</i>, ");
		}*/

		html.append("</u></b></b>." + "</tr>");
		html.append(
		...
		html.append("<p><p>");
		html.append(" <table align=\"center\" width=\"100%\">");
		html.append(" <tr><td><p>Campo Grande - MS, <b><u><i>" + "</i></u></b>.</p></td></tr>");
		html.append("</table>");
		...
		html.append("<img src=\"" + getClass().getResource("/br/com/psg/resources/gersonclaro.png")
				+ "\" alt=\"assinatura\" name=\"assinatura\" width=\"270\" hspace=\"12\" border=\"0\" align=\"top\" id=\"assinatura\"/>");
		html.append("</td>");
		html.append("</tr>");
		html.append("<tr>");
		html.append(" <td>");

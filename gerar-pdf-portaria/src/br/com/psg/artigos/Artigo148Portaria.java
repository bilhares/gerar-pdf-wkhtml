...
public class Artigo148Portaria {
	public String gerarPdf148Portaria(Parametro param) {
		...
		html.append("</head>");
		html.append("<body>");
//		html.append("<div><p><b><u><i>artigo_"+param.getARTIGO_INCISO_WORK()+" (PORTARIA)</i></u></b></P></div>");
		...
		html.append(
				"<tr>" + "<td colspan=\"2\"><img src=\""+getClass().getResource("/br/com/psg/resources/topoDetran2.png")+"\"alt=\"logo\" name=\"logo\"  width=\"900\" height=\"146\"  hspace=\"12\" border=\"0\" align=\"top\" id=\"logo\"/>"
						+ "</td>" + "</tr>");
		html.append("<tr><td width=\"50%\">PORTARIA <b><u><i>"+param.getNUM_PORTARIA()+"</i></u></b> / <b><u><i>"+param.getANO_PORTARIA()+"</i></u></b> - DETRAN-MS</td>"
				+ "<td width=\"50%\">Campo Grande, MS, <b><u><i>"+DataUtil.dataAtualExtenso()+"</i></u></b>.</td></tr>");
		html.append("</table>");
		html.append("<p>");
		html.append("<table align=\"center\" width=\"100%\">");
		html.append("<tr>"
				+ "<td align=\"justify\" width=\"90%\">O DIRETOR PRESIDENTE DO DEPARTAMENTO ESTADUAL DE TRÂNSITO DO"
						...
						+ "</tr>");
		html.append("<tr>"
						+ "<td align=\"justify\" width=\"90%\">CONSIDERANDO o que autoriza o artigo 256 em seus incisos e parágrafos e artigo 148 3º e 4º, ambos do CTB;</td>"
						+ "</tr>");
		html.append("<tr>"
						+ "<td align=\"justify\" width=\"90%\">RESOLVE:</td>"
						+ "</tr>");
		html.append("<tr>"
				+ "<td align=\"justify\" width=\"90%\">1° INSTAURAR processo administrativo em nome do condutor <b><u><i>"+param.getNOME_WORK()+"</i></u></b>, portador da CNH no <b><u><i>"+param.getNUMERO_CNH_WORK()+"</i></u></b>,"
						+ " sob o registro <b><u><i>"+param.getNUMERO_REGISTRO_WORK()+"</i></u></b> para a aplicação da penalidade de cassação da PPD e cancelamento da CNH definitiva, por infringência ao artigo <b><u><i>"+param.getARTIGO_COMPLETO()+"</i></u> do CTB</b>.</td>"
						+ "</tr>");
		html.append("<tr>"
				+ "<td align=\"justify\" width=\"90%\">2° Registre-se e expeça-se a competente notificação ao condutor, concedendo-lhe na forma do §"
						+ " 4° do artigo 10 da Resolução 182/2005, o prazo de 15 (quinze) dias para a apresentação de"
						+ " defesa a contar do recebimento da notificação.</td>"
						+ "</tr>");
		html.append("<tr>"
				+ "<td align=\"justify\" width=\"90%\">3° Informe-se que a não apresentação da defesa em tempo hábil determinará o seguimento do"
						+ "processo à revelia.</td>"
						+ "</tr>");
		html.append("</table>");
		html.append("<p><p>");
		html.append("<p><p>");
		html.append(" <table align=\"center\" width=\"100%\">");
		html.append(" <tr><td><p>Campo Grande - MS, <b><u><i>"
				+ "</i></u></b>.</p></td></tr>");
		html.append("</table>");
		...
		html.append("<tr>");
		html.append(" <td>");
		html.append("<p>GERSON CLARO DINO<br />"
				+ "<strong>Diretor Presidente DETRAN-MS</strong></p>");
		html.append("</td>");
		html.append("</tr>");
		html.append("</table>");
		html.append("</div>");

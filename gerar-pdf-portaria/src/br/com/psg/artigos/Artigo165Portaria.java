...
public class Artigo165Portaria {
	public String gerarPdf165Portaria(Parametro param) {
...
//		html.append("<h1 style=\"text-align: center\">artigo_" + param.getARTIGO_INCISO_WORK() + " (PORTARIA)</h1>");
		...
		html.append(
				"<tr>" + "<td align=\"justify\" width=\"90%\">O DIRETOR PRESIDENTE DO DEPARTAMENTO ESTADUAL DE TRÂNSITO DO"
						...
						+ "</tr>");
		html.append(
				"<tr>" + "<td align=\"justify\" width=\"90%\">CONSIDERANDO o que autoriza o artigo 256 em seus incisos e parágrafos, do CTB;</td>"
						+ "</tr>");
		html.append(
		...
		html.append("<tr><td>1º INSTAURAR processo administrativo em nome do condutor <b><u><i>"+param.getNOME_WORK()+"</i></u></b>,"
				+ " portador da CNH nº <b><u><i>"+param.getNUMERO_CNH_WORK()+"</i></u></b>, sob o registro <b><u><i>"+param.getNUMERO_REGISTRO_WORK()+"</i></u></b> "
						+ "para a aplicação da penalidade de suspensão do direito de conduzir veículos automotores, por infringência ao artigo <b>"+param.getARTIGO_COMPLETO()+" do CTB.</td></tr>");

...
public class PortariaDefault {

	public String gerarPdfDefaultPortaria(Parametro param) {
		...
		html.append("</head>");
		html.append("<body>");
//		html.append("<div><p><b><u><i> Else (PORTARIA)</i></u></b></P></div>");
		...
		html.append("<p><p>");
		html.append(" <table align=\"center\" width=\"100%\">");
		html.append(" <tr><td><p>Campo Grande - MS, "+ DataUtil.dataAtualExtenso()+" <b><u><i>" + "</i></u></b>.</p></td></tr>");
		html.append("</table>");

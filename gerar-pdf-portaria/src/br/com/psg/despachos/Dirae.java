...
public class Dirae {
	public String gerarDirae() {
		...
		html.append("<tr><td align=\"justify\" width=\"90%\"><b>À Presidência,</b></td></tr>");
		...
		html.append(
				"<tr><td align=\"justify\" width=\"90%\">Encaminho para análise quanto à expedição da Portaria de Suspensão da Carteira Nacional de"
						+ " Habilitação do referido condutor, conforme despacho da Divisão de Condutores.</td></tr>");
		...
		String arquivo = "";
		String nomeArquivo = "despacho-dirae";
		try {

...
public class DiconDirhabNaoConhecimento {
	
	public String gerarProvimentoDefesa(Despachos despacho){
		...
		html.append("<table align=\"center\" width=\"100%\"><tr><td align=\"left\" width=\"100%\" style=\"text-indent: 55px;\"><b>À DIRHAB – DIRETORIA DE HABILITAÇÃO</b></td></tr></table>");
		
		html.append("<table align=\"center\" width=\"100%\" style=\"margin-top: 30px\">");
		
		html.append("<tr><td align=\"justify\" width=\"90%\" style=\"text-indent: 55px;\">Encaminhamos o presente processo "+despacho.getNumProcesso()+", devidamente relatado com o não conhecimento do recurso interposto para envio"
				+ " a presidência a fim de analise e S.M.J., acolhimento e publicação da competente portaria de aplicação de penalidade.</td></tr>");
		html.append("</table>");
		...
		html.append("<tr><td>");
		html.append("<img src=\""
				+ getClass().getResource("/br/com/psg/resources/assinatura_luis.png")
				+ "\" alt=\"assinatura\" name=\"assinatura\" width=\"168\" height=\"122\" hspace=\"12\" border=\"0\" align=\"top\" id=\"assinatura\"/></td></tr>");

		html.append(
				"<tr><td>  <p><b>Luiz Fernando Ferreira dos Santos</b><br /> Chefe da Divisão de Registro de Condutores – DICON<br>DETRAN / MS</p></td></tr>");
		...
		String arquivo = "";
		String nomeArquivo = "dicon-dirhab-nao-conhec";
		try {

...
public class DirhabJariEnvioDefesa {
	public String gerarDefesaProvida() {
		...
		html.append("<tr><td align=\"justify\" width=\"90%\"><b>À <br/> JARI - Junta Administrativa de Recursos de Infrações</b></td></tr>");

		html.append("</table>");

		html.append("<table align=\"center\" width=\"100%\" style=\"margin-top: 45px\">");

		html.append("<tr><td align=\"justify\" width=\"90%\">Considerando o que determina a legislação de trânsito sobre a apreciação de recurso por aplicação de penalidade por "
				+ "autoridade executiva de trânsito, encaminhamos o presente processo para apreciação.</td></tr>");
		...
		String arquivo = "";
		String nomeArquivo = "dirhab-jari-envio-def";
		try {

...
public class DespachoImprovimentoDefesa {
	
	public String gerarImprovimentoDefesa(Despachos despacho){
		...
		html.append("<tr><td align=\"justify\" width=\"90%\">Tendo em vista o IMPROVIMENTO da defesa escrita, encaminhamos o processo "+despacho.getNumProcesso()+" para prosseguimento do feito.</td></tr>");
		html.append("</table>");
		...
		String arquivo = "";
		String nomeArquivo = "improvimento-defesa";
		try {

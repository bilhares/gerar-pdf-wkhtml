...
public class AnaliseDefesaDicon {
public String gerarAnaliseDefesa(Despachos despacho){
		...
		html.append("<tr><td align=\"justify\" width=\"90%\"><b>Á DIRHAB - DIRETORIA DE HABILITAÇÃO</b></td></tr>");
		
		html.append("<tr><td></td></tr>");
		
		html.append("<tr><td align=\"justify\" width=\"90%\">Encaminhamos o presente processo , devidamente relatado com improvimento do recurso interposto para envio a presidência a fim de análise e S.M.J., "
				+ "acolhimento e publicação da competente portaria de aplicação de penalidade.</td></tr>");
		...
		html.append(
				"<tr><td>  <p>LUIZ FERNANDO FERREIRA DOS SANTOS<br /><b>Chefe da Divisão de Registro de Condutores<br>DETRAN / MS</b></p></td></tr>");
		...
		String arquivo = "";
		String nomeArquivo = "analise-defesa-dicon";
		try {

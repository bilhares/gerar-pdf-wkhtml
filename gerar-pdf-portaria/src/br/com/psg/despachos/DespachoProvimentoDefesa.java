...
public class DespachoProvimentoDefesa {
	...
	public String gerarProvimentoDefesa(Despachos despacho){
		...
		html.append("<table align=\"center\" width=\"100%\"><tr><td align=\"left\" width=\"100%\"><b>À DICON</b></td></tr></table>");
		
		html.append("<table align=\"center\" width=\"100%\" style=\"margin-top: 30px\">");
		
		html.append("<tr><td align=\"justify\" width=\"90%\">Tendo em vista o PROVIMENTO da defesa escrita, encaminhamos o processo "+despacho.getNumProcesso()+" para prosseguimento do feito.</td></tr>");
		html.append("</table>");
		...
		String arquivo = "";
		String nomeArquivo = "provimento-defesa";
		try {

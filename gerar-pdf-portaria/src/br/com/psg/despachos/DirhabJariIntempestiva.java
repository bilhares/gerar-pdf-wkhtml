...
public class DirhabJariIntempestiva {
	public String gerarDefesaProvida() {
		...
		html.append("<tr><td align=\"justify\" width=\"90%\">Encaminhamos o presente processo, para conhecimento e deliberação, visto que foi protocolado recurso intempestivo, em anexo, "
				+ "contra a penalidade aplicada.</td></tr>");
		...
		String arquivo = "";
		String nomeArquivo = "dirhab-jari-intempestivo";
		try {
